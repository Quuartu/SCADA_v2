...
public class FolderBarLogic : BaseNetLogic
{
	public override void Start()
	{
		...
		accessNetworkDrivesVariable = Owner.Owner.Owner.Owner.GetVariable("AccessNetworkDrives");
	...
	{
		foreach (IUAVariable location in locationsObject.Children.OfType<IUAVariable>())
